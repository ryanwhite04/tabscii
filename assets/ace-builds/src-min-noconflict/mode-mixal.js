/// BareSpecifier=ace-builds/src-min-noconflict/mode-mixal
    ...
    var r = e("../lib/oop"),
        ...
        var e = function (e) {
            ...
            return e && e.search(/[^ A-Z\u0394\u03a0\u03a30-9.,()+*/=$<>@;:'-]/) == -1;
                ...
                }, regex: /^(\S+)?( +)(\S+)( +)(\S+)(\s+.*)?$/ }, { defaultToken: "text" }] };
