/// BareSpecifier=ace-builds/src-min-noconflict/mode-csound_score
            ...
            return { regex: e.regex, onMatch: function (t, n, r, i) {
                    ...
                    if (Array.isArray(e.next)) {
                        var n = e.next[e.next.length - 1],
                            r = n.length - 1,
                            i = t.length - 1;if (i > r) while (r >= 0 && i >= 0) {
                            if (n.charAt(r) !== t.charAt(i)) {
                                var s = t.substr(0, i);for (var o = 0; o < e.next.length; o++) e.next[o] = s + e.next[o];break;
                            }r--, i--;
                        }
                    } else e.next = t;
                }, get token() {
