/// BareSpecifier=ace-builds/src-min-noconflict/mode-logiql
ace.define("ace/mode/logiql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        this.lineCommentStart = "//", this.blockComment = { start: "/*", end: "*/" }, this.getNextLineIndent = function (e, t, n) {
            ...
            t == undefined && (t = e.selection.lead), typeof t == "object" && (n = t.column, t = t.row);var r = e.getTokenAt(t, n),
                i = "keyword.start",
                s = "keyword.end",
            ...
            }while (o = f.step()) if (o.type == i || o.type == s) break;if (!o || o.type == r.type) return;var l = f.getCurrentTokenColumn(),
