/// BareSpecifier=ace-builds/src-min-noconflict/worker-json
"no use strict";
!function (e) {
  function t(e, t) {
    var n = e,
  ...
  var r,
    ...
    return e && e !== i && u("Expected '" + e + "' instead of '" + i + "'"), i = o.charAt(r), r += 1, i;
      ...
      f = function () {
    var e,
        t = "";i === "-" && (t = "-", a("-"));while (i >= "0" && i <= "9") t += i, a();if (i === ".") {
      t += ".";while (a() && i >= "0" && i <= "9") t += i;
    }if (i === "e" || i === "E") {
      t += i, a();if (i === "-" || i === "+") t += i, a();while (i >= "0" && i <= "9") t += i, a();
    ...
    var n;return o = e, r = 0, i = " ", n = p(), c(), i && u("Syntax error"), typeof t == "function" ? function s(e, n) {
      var r,
          i,
          o = e[n];if (o && typeof o == "object") for (r in o) Object.hasOwnProperty.call(o, r) && (i = s(o, r), i !== undefined ? o[r] = i : delete o[r]);return t.call(e, n, o);
    }({ "": n }, "") : n;
  };
  ...
  var r = e("../lib/oop"),
    ...
    this.onUpdate = function () {
      var e = this.doc.getValue(),
        ...
        var r = this.doc.indexToPosition(n.at - 1);t.push({ row: r.row, column: r.column, text: n.message, type: "error" });
