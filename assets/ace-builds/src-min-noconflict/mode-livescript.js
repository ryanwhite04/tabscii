/// BareSpecifier=ace-builds/src-min-noconflict/mode-livescript
ace.define("ace/mode/matching_brace_outdent", ["require", "exports", "module", "ace/range"], function (e, t, n) {
    ...
    function u(e, t) {
        ...
        function o() {
            var t;this.$tokenizer = new (e("../tokenizer").Tokenizer)(o.Rules);if (t = e("../mode/matching_brace_outdent")) this.$outdent = new t.MatchingBraceOutdent();this.$id = "ace/mode/livescript", this.$behaviour = new (e("./behaviour/cstyle").CstyleBehaviour)();
        }var n,
