/// BareSpecifier=ace-builds/src-min-noconflict/mode-asciidoc
    ...
    var r = e("../../lib/oop"),
        ...
        this.foldingStartMarker = /^(?:\|={10,}|[\.\/=\-~^+]{4,}\s*$|={1,5} )/, this.singleLineHeadingRe = /^={1,5}(?=\s+\S)/, this.getFoldWidget = function (e, t, n) {
            ...
            function l(t) {
                ...
                }var g = f && f.value.match(this.singleLineHeadingRe);a = g ? n - 1 : n - 2;if (a > u) while (a > u && (!l(a) || f.value[0] == "[")) a--;if (a > u) {
                    var y = e.getLine(a).length;return new s(u, i, a, y);
                }
            } else {
                var b = e.bgTokenizer.getState(n);if (b == "dissallowDelimitedBlock") {
                    while (n-- > 0) if (e.bgTokenizer.getState(n).lastIndexOf("Block") == -1) break;a = n + 1;if (a < u) {
                        var y = e.getLine(n).length;return new s(a, 5, u, i - 5);
                    }
                } else {
                    while (++n < o) if (e.bgTokenizer.getState(n) == "dissallowDelimitedBlock") break;a = n;if (a > u) {
