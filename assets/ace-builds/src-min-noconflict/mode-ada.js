/// BareSpecifier=ace-builds/src-min-noconflict/mode-ada
    ...
    var r = e("../lib/oop"),
        ...
        this.lineCommentStart = "--", this.getNextLineIndent = function (e, t, n) {
            var r = this.$getIndent(t),
                ...
                var o = t.match(/^.*(begin|loop|then|is|do)\s*$/);o && (r += n);
            }return r;
        }, this.checkOutdent = function (e, t, n) {
            var r = t + n;return r.match(/^\s*(begin|end)$/) ? !0 : !1;
        }, this.autoOutdent = function (e, t, n) {
            var r = t.getLine(n),
                i = t.getLine(n - 1),
                s = this.$getIndent(i).length,
                u = this.$getIndent(r).length;if (u <= s) return;t.outdentRows(new o(n, 0, n + 2, 0));
