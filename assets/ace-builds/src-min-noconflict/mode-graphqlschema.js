/// BareSpecifier=ace-builds/src-min-noconflict/mode-graphqlschema
ace.define("ace/mode/graphqlschema_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        var e = "type|interface|union|enum|schema|input|implements|extends|scalar",
            ...
            n = this.createKeywordMapper({ keyword: e, "storage.type": t }, "identifier");this.$rules = { start: [{ token: "comment", regex: "#.*$" }, { token: "paren.lparen", regex: /[\[({]/, next: "start" }, { token: "paren.rparen", regex: /[\])}]/ }, { token: n, regex: "[a-zA-Z_$][a-zA-Z0-9_$]*\\b" }] }, this.normalizeRules();
