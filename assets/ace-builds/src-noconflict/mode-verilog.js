/// BareSpecifier=ace-builds/src-noconflict/mode-verilog
    ...
    var VerilogHighlightRules = function () {
        ...
        this.$rules = {
            "start": [{
                ...
                token: "string.start",
                regex: '"',
                next: [{ token: "constant.language.escape", regex: /\\(?:[ntvfa\\"]|[0-7]{1,3}|\x[a-fA-F\d]{1,2}|)/, consumeLineEnd: true }, { token: "string.end", regex: '"|$', next: "start" }, { defaultToken: "string" }]
            }, {
                token: "string",
                regex: "'^[']'"
            }, {
