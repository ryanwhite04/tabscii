/// BareSpecifier=ace-builds/src-noconflict/mode-csound_orchestra
    ...
    var CsoundOrchestraHighlightRules = function () {
        ...
        start.push(this.pushRule({
            ...
            regex: /\b([A-Z_a-z]\w*)(?:(:)([A-Za-z]))?\b/, onMatch: function (value, currentState, stack, line) {
                ...
                if (type) {
                    if (tokens[2]) {
                        return [{ type: type, value: name }, { type: "punctuation.type-annotation.csound", value: tokens[2] }, { type: "type-annotation.storage.type.csound", value: tokens[3] }];
                    }
                    return type;
                }
                return "text.csound";
