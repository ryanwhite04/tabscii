...
module.exports = function (grunt) {
	grunt.initConfig({
		concat: {
			...
			'js/midi/audioDetect.js', 'js/midi/gm.js', 'js/midi/loader.js', 'js/midi/player.js', 'js/midi/plugin.audiotag.js', 'js/midi/plugin.webaudio.js', 'js/midi/plugin.webmidi.js',
			...
			'inc/polyfill/Base64.js', 'inc/polyfill/base64binary.js']
		},
		uglify: {
