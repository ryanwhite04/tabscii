/// BareSpecifier=tone/Tone/core/Context
define(["Tone/core/Tone", "Tone/core/Emitter", "Tone/core/Timeline", "Tone/shim/AudioContext"], function (Tone) {
  ...
  */
	Ticker.prototype._createWorker = function () {
		...
		//onmessage callback
		"self.onmessage = function(msg){" + "	timeoutTime = parseInt(msg.data);" + "};" +
		//the tick function which posts a message
		//and schedules a new tick
		"function tick(){" + "	setTimeout(tick, timeoutTime);" + "	self.postMessage('tick');" + "}" +
		//call tick initially
		"tick();"]);
