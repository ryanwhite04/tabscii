/// BareSpecifier=ace-builds/src-noconflict/mode-csharp
    ...
    var CSharpHighlightRules = function () {
        ...
        this.$rules = {
            "start": [{
                ...
                token: "string", start: /\$"/, end: '"|$', next: [{ token: "constant.language.escape", regex: /\\(:?$)|{{/ }, { token: "constant.language.escape", regex: /\\(:?u[\da-fA-F]+|x[\da-fA-F]+|[tbrf'"n])/ }, { token: "invalid", regex: /\\./ }]
            }, {
