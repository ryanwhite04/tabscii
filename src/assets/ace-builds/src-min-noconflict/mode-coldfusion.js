/// BareSpecifier=ace-builds/src-min-noconflict/mode-coldfusion
ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        s.call(this), this.$rules.tag[2].token = function (e, t) {
            var n = t.slice(0, 2) == "cf" ? "keyword" : "meta.tag";return ["meta.tag.punctuation." + (e == "<" ? "" : "end-") + "tag-open.xml", n + ".tag-name.xml"];
        };var e = Object.keys(this.$rules).filter(function (e) {
            return (/^(js|css)-/.test(e)
            );
        });this.embedRules({ cfmlComment: [{ regex: "<!---", token: "comment.start", push: "cfmlComment" }, { regex: "--->", token: "comment.end", next: "pop" }, { defaultToken: "comment" }] }, "", [{ regex: "<!---", token: "comment.start", push: "cfmlComment" }], ["comment", "start", "tag_whitespace", "cdata"].concat(e)), this.$rules.cfTag = [{ include: "attributes" }, { token: "meta.tag.punctuation.tag-close.xml", regex: "/?>", next: "pop" }];var t = { token: function (e, t) {
                return ["meta.tag.punctuation." + (e == "<" ? "" : "end-") + "tag-open.xml", "keyword.tag-name.xml"];
            }, regex: "(</?)(cf[-_a-zA-Z0-9:.]+)", push: "cfTag" };e.forEach(function (e) {
