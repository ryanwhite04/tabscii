/// BareSpecifier=ace-builds/src-min-noconflict/mode-sqlserver
ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        }), s = s.sort().join("|");var o = this.createKeywordMapper({ "constant.language": e, "storage.type": n, "support.function": t, "support.storedprocedure": r, keyword: s }, "identifier", !0),
    ...
    var r = e("../../lib/oop"),
        ...
        this.foldingStartMarker = /(\bCASE\b|\bBEGIN\b)|^\s*(\/\*)/i, this.startRegionRe = /^\s*(\/\*|--)#?region\b/, this.getFoldWidgetRange = function (e, t, n, r) {
            var i = e.getLine(n);if (this.startRegionRe.test(i)) return this.getCommentRegionBlock(e, i, n);var s = i.match(this.foldingStartMarker);if (s) {
                var o = s.index;if (s[1]) return this.getBeginEndBlock(e, n, o, s[1]);var u = e.getCommentFoldRange(n, o + s[0].length, 1);return u && !u.isMultiLine() && (r ? u = this.getSectionRange(e, n) : t != "all" && (u = null)), u;
            }if (t === "markbegin") return;return;
        }, this.getBeginEndBlock = function (e, t, n, r) {
            var s = { row: t, column: n + r.length },
                o = e.getLength(),
                u,
                a = 1,
                f = /(\bCASE\b|\bBEGIN\b)|(\bEND\b)/i;while (++t < o) {
                u = e.getLine(t);var l = f.exec(u);if (!l) continue;l[1] ? a++ : a--;if (!a) break;
            }var c = t;if (c > s.row) return new i(s.row, s.column, c, u.length);
        };
    }.call(o.prototype);
    ...
    var r = e("../lib/oop"),
        ...
        this.lineCommentStart = "--", this.blockComment = { start: "/*", end: "*/" }, this.getCompletions = function (e, t, n, r) {
