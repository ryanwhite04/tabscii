/// BareSpecifier=ace-builds/src-min-noconflict/ext-keybinding_menu
ace.define("ace/ext/menu_tools/overlay_page", ["require", "exports", "module", "ace/lib/dom"], function (e, t, n) {
    ...
    function i(t) {
        ...
        r.prototype.showKeyboardShortcuts = function () {
            i(this);
        }, e.commands.addCommands([{ name: "showKeyboardShortcuts", bindKey: { win: "Ctrl-Alt-h", mac: "Command-Alt-h" }, exec: function (e, t) {
