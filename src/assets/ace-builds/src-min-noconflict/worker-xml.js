/// BareSpecifier=ace-builds/src-min-noconflict/worker-xml
"no use strict";
!function (e) {
  function t(e, t) {
    var n = e,
  ...
  function d() {}function v(e, t, n, r, i) {
    function s(e) {
      if (e > 65535) {
        e -= 65536;var t = 55296 + (e >> 10),
            n = 56320 + (e & 1023);return String.fromCharCode(t, n);
      }return String.fromCharCode(e);
    }function o(e) {
      var t = e.slice(1, -1);return t in n ? n[t] : t.charAt(0) === "#" ? s(parseInt(t.substr(1).replace("x", "0x"))) : (i.error("entity not found:" + e), e);
    }function u(t) {
      var n = e.substring(v, t).replace(/&#?\w+;/g, o);h && a(v), r.characters(n, 0, t - v), v = t;
    }function a(t, n) {
      while (t >= l && (n = c.exec(e))) f = n.index, l = f + n[0].length, h.lineNumber++;h.columnNumber = t - f + 1;
    }var f = 0,
        l = 0,
        c = /.+(?:\r\n?|\n)|.*$/g,
        h = r.locator,
        ...
        d = {},
        v = 0;for (;;) {
      var E = e.indexOf("<", v);if (E < 0) {
        if (!e.substr(v).match(/^\s*$/)) {
          var N = r.document,
              C = N.createTextNode(e.substr(v));N.appendChild(C), r.currentElement = C;
        }return;
      }E > v && u(E);switch (e.charAt(E + 1)) {case "/":
          var k = e.indexOf(">", E + 3),
              L = e.substring(E + 2, k),
              A;if (!(p.length > 1)) {
            i.fatalError("end tag name not found for: " + L);break;
          }A = p.pop();var O = A.localNSMap;A.tagName != L && i.fatalError("end tag name: " + L + " does not match the current start tagName: " + A.tagName), r.endElement(A.uri, A.localName, L);if (O) for (var M in O) r.endPrefixMapping(M);k++;break;case "?":
          h && a(E), k = x(e, E, r);break;case "!":
          h && a(E), k = S(e, E, r, i);break;default:
          try {
            h && a(E);var _ = new T(),
                k = g(e, E, _, o, i),
                D = _.length;if (D && h) {
              var P = m(h, {});for (var E = 0; E < D; E++) {
                var H = _[E];a(H.offset), H.offset = m(h, {});
              }m(P, h);
    ...
    var s,
        ...
        v = ++t,
        m = o;for (;;) {
      var g = e.charAt(v);switch (g) {case "=":
          if (m === u) s = e.slice(t, v), m = f;else {
            if (m !== a) throw new Error("attribute equal must after attrName");m = f;
          }break;case "'":case '"':
          if (m === f) {
            t = v + 1, v = e.indexOf(g, t);if (!(v > 0)) throw new Error("attribute value no end '" + g + "' match");d = e.slice(t, v).replace(/&#?\w+;/g, r), n.add(s, d, t - 1), m = c;
          } else {
            if (m != l) throw new Error('attribute value must after "="');d = e.slice(t, v).replace(/&#?\w+;/g, r), n.add(s, d, t), i.warning('attribute "' + s + '" missed start quot(' + g + ")!!"), t = v + 1, m = c;
          }break;case "/":
          switch (m) {case o:
              n.setTagName(e.slice(t, v));case c:case h:case p:
              m = p, n.closed = !0;case l:case u:case a:
              break;default:
              throw new Error("attribute invalid close char('/')");}break;case "":
          i.error("unexpected end of input");case ">":
          switch (m) {case o:
              n.setTagName(e.slice(t, v));case c:case h:case p:
              break;case l:case u:
              d = e.slice(t, v), d.slice(-1) === "/" && (n.closed = !0, d = d.slice(0, -1));case a:
              m === a && (d = s), m == l ? (i.warning('attribute "' + d + '" missed quot(")!!'), n.add(s, d.replace(/&#?\w+;/g, r), t)) : (i.warning('attribute "' + d + '" missed value!! "' + d + '" instead!!'), n.add(d, d, t));break;case f:
              throw new Error("attribute value missed!!");}return v;case "\u0080":
          g = " ";default:
          if (g <= " ") switch (m) {case o:
              n.setTagName(e.slice(t, v)), m = h;break;case u:
              s = e.slice(t, v), m = a;break;case l:
              var d = e.slice(t, v).replace(/&#?\w+;/g, r);i.warning('attribute "' + d + '" missed quot(")!!'), n.add(s, d, t);case c:
              m = h;} else switch (m) {case a:
              i.warning('attribute "' + s + '" missed value!! "' + s + '" instead!!'), n.add(s, s, t), t = v, m = u;break;case c:
              i.warning('attribute space is required"' + s + '"!!');case h:
              m = u, t = v;break;case f:
              m = l, t = v;break;case p:
              throw new Error("elements closed character '/' and '>' must be connected to");}}v++;
    }
  }function y(e, t, n) {
    var r = e.tagName,
        i = null,
      ...
      var u = e[o],
          a = u.qName,
          f = u.value,
          l = a.indexOf(":");if (l > 0) var c = u.prefix = a.slice(0, l),
          h = a.slice(l + 1),
          p = c === "xmlns" && h;else h = a, c = null, p = a === "xmlns" && "";u.localName = h, p !== !1 && (i == null && (i = {}, E(s, s = {})), s[p] = i[p] = f, u.uri = "http://www.w3.org/2000/xmlns/", t.startPrefixMapping(p, f));
    }var o = e.length;while (o--) {
      u = e[o];var c = u.prefix;c && (c === "xml" && (u.uri = "http://www.w3.org/XML/1998/namespace"), c !== "xmlns" && (u.uri = s[c]));
      ...
      t.endElement(d, h, r);if (i) for (c in i) t.endPrefixMapping(c);
    } else e.currentNSMap = s, e.localNSMap = i, n.push(e);
  }function b(e, t, n, r, i) {
    if (/^(?:script|textarea)$/i.test(n)) {
      var s = e.indexOf("</" + n + ">", t),
          o = e.substring(t + 1, s);if (/[&<]/.test(o)) return (/^script$/i.test(n) ? (i.characters(o, 0, o.length), s) : (o = o.replace(/&#?\w+;/g, r), i.characters(o, 0, o.length), s)
      );
    }return t + 1;
  }function w(e, t, n, r) {
    var i = r[n];return i == null && (i = r[n] = e.lastIndexOf("</" + n + ">")), i < t;
  }function E(e, t) {
    for (var n in e) t[n] = e[n];
  }function S(e, t, n, r) {
    var i = e.charAt(t + 2);switch (i) {case "-":
        if (e.charAt(t + 3) === "-") {
          var s = e.indexOf("-->", t + 4);return s > t ? (n.comment(e, t + 4, s - t - 4), s + 3) : (r.error("Unclosed comment"), -1);
        }return -1;default:
        if (e.substr(t + 3, 6) == "CDATA[") {
          var s = e.indexOf("]]>", t + 9);return n.startCDATA(), n.characters(e, t + 9, s - t - 9), n.endCDATA(), s + 3;
        }var o = C(e, t),
            u = o.length;if (u > 1 && /!doctype/i.test(o[0][0])) {
          var a = o[1][0],
              f = u > 3 && /^public$/i.test(o[2][0]) && o[3][0],
              l = u > 4 && o[4][0],
              c = o[u - 1];return n.startDTD(a, f && f.replace(/^(['"])(.*?)\1$/, "$2"), l && l.replace(/^(['"])(.*?)\1$/, "$2")), n.endDTD(), c.index + c[0].length;
        }}return -1;
  }function x(e, t, n) {
    var r = e.indexOf("?>", t);if (r) {
      var i = e.substring(t, r).match(/^<\?(\S*)\s*([\s\S]*?)\s*$/);if (i) {
        var s = i[0].length;return n.processingInstruction(i[1], i[2]), r + 2;
      }return -1;
    }return -1;
  }function T(e) {}function N(e, t) {
    return e.__proto__ = t, e;
  }function C(e, t) {
    var n,
        r = [],
        i = /'[^']+'|"[^"]+"|[^\s<>\/=]+=?|(\/?\s*>|<)/g;i.lastIndex = t, i.exec(e);while (n = i.exec(e)) {
      r.push(n);if (n[1]) return r;
    }
      ...
      c = 5,
      h = 6,
      p = 7;return d.prototype = { parse: function (e, t, n) {
      var r = this.domBuilder;r.startDocument(), E(t, t = {}), v(e, t, n, r, this.errorHandler), r.endDocument();
    } }, T.prototype = { setTagName: function (e) {
      if (!s.test(e)) throw new Error("invalid tagName:" + e);this.tagName = e;
    }, add: function (e, t, n) {
      if (!s.test(e)) throw new Error("invalid attribute:" + e);this[this.length++] = { qName: e, value: t, offset: n };
  ...
  function r(e, t) {
    ...
    var n = function () {},
        i = e.prototype;if (Object.create) {
      var s = Object.create(t.prototype);i.__proto__ = s;
    ...
    if (t instanceof Error) var n = t;else n = this, Error.call(this, w[e]), this.message = w[e], Error.captureStackTrace && Error.captureStackTrace(this, B);return n.code = e, t && (this.message = this.message + ": " + t), n;
  }function j() {}function F(e, t) {
    this._node = e, this._refresh = t, I(this);
  }function I(e) {
    var t = e._node._inc || e._node.ownerDocument._inc;if (e._inc != t) {
      var n = e._refresh(e._node);gt(e, "length", n.length), r(n, e), e._inc = t;
    }
  }function q() {}function R(e, t) {
    var n = e.length;while (n--) if (e[n] === t) return n;
  }function U(e, t, n, r) {
    r ? t[R(t, r)] = n : t[t.length++] = n;if (e) {
      n.ownerElement = e;var i = e.ownerDocument;i && (r && Q(i, e, r), K(i, e, n));
    }
  }function z(e, t, n) {
    var r = R(t, n);if (!(r >= 0)) throw new B(L, new Error());var i = t.length - 1;while (r < i) t[r] = t[++r];t.length = i;if (e) {
      var s = e.ownerDocument;s && (Q(s, e, n), n.ownerElement = null);
    }
  }function W(e) {
    this._features = {};if (e) for (var t in e) this._features = e[t];
  }function X() {}function V(e) {
    return e == "<" && "&lt;" || e == ">" && "&gt;" || e == "&" && "&amp;" || e == '"' && "&quot;" || "&#" + e.charCodeAt() + ";";
  }function $(e, t) {
    if (t(e)) return !0;if (e = e.firstChild) do if ($(e, t)) return !0; while (e = e.nextSibling);
  }function J() {}function K(e, t, n) {
    e && e._inc++;var r = n.namespaceURI;r == "http://www.w3.org/2000/xmlns/" && (t._nsMap[n.prefix ? n.localName : ""] = n.value);
  }function Q(e, t, n, r) {
    e && e._inc++;var i = n.namespaceURI;i == "http://www.w3.org/2000/xmlns/" && delete t._nsMap[n.prefix ? n.localName : ""];
  }function G(e, t, n) {
    if (e && e._inc) {
      e._inc++;var r = t.childNodes;if (n) r[r.length++] = n;else {
        var i = t.firstChild,
            s = 0;while (i) r[s++] = i, i = i.nextSibling;r.length = s;
      }
    }
  }function Y(e, t) {
    var n = t.previousSibling,
        r = t.nextSibling;return n ? n.nextSibling = r : e.firstChild = r, r ? r.previousSibling = n : e.lastChild = n, G(e.ownerDocument, e), t;
  }function Z(e, t, n) {
    var r = t.parentNode;r && r.removeChild(t);if (t.nodeType === g) {
      var i = t.firstChild;if (i == null) return t;var s = t.lastChild;
    } else i = s = t;var o = n ? n.previousSibling : e.lastChild;i.previousSibling = o, s.nextSibling = n, o ? o.nextSibling = i : e.firstChild = i, n == null ? e.lastChild = s : n.previousSibling = s;do i.parentNode = e; while (i !== s && (i = i.nextSibling));return G(e.ownerDocument || e, e), t.nodeType == g && (t.firstChild = t.lastChild = null), t;
  }function et(e, t) {
    var n = t.parentNode;if (n) {
      var r = e.lastChild;n.removeChild(t);var r = e.lastChild;
    }var r = e.lastChild;return t.parentNode = e, t.previousSibling = r, t.nextSibling = null, r ? r.nextSibling = t : e.firstChild = t, e.lastChild = t, G(e.ownerDocument, e, t), t;
  }function tt() {
    this._nsMap = {};
  }function nt() {}function rt() {}function it() {}function st() {}function ot() {}function ut() {}function at() {}function ft() {}function lt() {}function ct() {}function ht() {}function pt() {}function dt(e, t) {
    switch (e.nodeType) {case u:
        var n = e.attributes,
            r = n.length,
            i = e.firstChild,
            o = e.tagName,
            h = s === e.namespaceURI;t.push("<", o);for (var y = 0; y < r; y++) dt(n.item(y), t);if (i || h && !/^(?:meta|link|img|br|hr|input|button)$/i.test(o)) {
          t.push(">");if (h && /^script$/i.test(o)) i && t.push(i.data);else while (i) dt(i, t), i = i.nextSibling;t.push("</", o, ">");
        } else t.push("/>");return;case v:case g:
        var i = e.firstChild;while (i) dt(i, t), i = i.nextSibling;return;case a:
        return t.push(" ", e.name, '="', e.value.replace(/[<&"]/g, V), '"');case f:
        return t.push(e.data.replace(/[<&]/g, V));case l:
        return t.push("<![CDATA[", e.data, "]]>");case d:
        return t.push("<!--", e.data, "-->");case m:
        var b = e.publicId,
            w = e.systemId;t.push("<!DOCTYPE ", e.name);if (b) t.push(' PUBLIC "', b), w && w != "." && t.push('" "', w), t.push('">');else if (w && w != ".") t.push(' SYSTEM "', w, '">');else {
          var E = e.internalSubset;E && t.push(" [", E, "]"), t.push(">");
        }return;case p:
        return t.push("<?", e.target, " ", e.data, "?>");case c:
        return t.push("&", e.nodeName, ";");default:
        t.push("??", e.nodeName);}
  }function vt(e, t, n) {
    var r;switch (t.nodeType) {case u:
        r = t.cloneNode(!1), r.ownerDocument = e;case g:
        break;case a:
        n = !0;}r || (r = t.cloneNode(!1)), r.ownerDocument = e, r.parentNode = null;if (n) {
      var i = t.firstChild;while (i) r.appendChild(vt(e, i, n)), i = i.nextSibling;
    }return r;
  }function mt(e, t, n) {
    var r = new t.constructor();for (var i in t) {
      var s = t[i];typeof s != "object" && s != r[i] && (r[i] = s);
    }t.childNodes && (r.childNodes = new j()), r.ownerDocument = e;switch (r.nodeType) {case u:
        var o = t.attributes,
            f = r.attributes = new q(),
            l = o.length;f._ownerElement = r;for (var c = 0; c < l; c++) r.setAttributeNode(mt(e, o.item(c), !0));break;case a:
        n = !0;}if (n) {
      var h = t.firstChild;while (h) r.appendChild(mt(e, h, n)), h = h.nextSibling;
    }return r;
  }function gt(e, t, n) {
    e[t] = n;
  }function yt(e) {
    switch (e.nodeType) {case 1:case 11:
        var t = [];e = e.firstChild;while (e) e.nodeType !== 7 && e.nodeType !== 8 && t.push(yt(e)), e = e.nextSibling;return t.join("");default:
        return e.nodeValue;}
      ...
      H = b.INVALID_ACCESS_ERR = (w[15] = "Invalid access", 15);B.prototype = Error.prototype, r(b, B), j.prototype = { length: 0, item: function (e) {
      return this[e] || null;
    } }, F.prototype.item = function (e) {
    return I(this), this[e];
  }, i(F, j), q.prototype = { length: 0, item: j.prototype.item, getNamedItem: function (e) {
      var t = this.length;while (t--) {
        var n = this[t];if (n.nodeName == e) return n;
      }
    }, setNamedItem: function (e) {
      var t = e.ownerElement;if (t && t != this._ownerElement) throw new B(O);var n = this.getNamedItem(e.nodeName);return U(this._ownerElement, this, e, n), n;
    }, setNamedItemNS: function (e) {
      var t = e.ownerElement,
          n;if (t && t != this._ownerElement) throw new B(O);return n = this.getNamedItemNS(e.namespaceURI, e.localName), U(this._ownerElement, this, e, n), n;
    }, removeNamedItem: function (e) {
      var t = this.getNamedItem(e);return z(this._ownerElement, this, t), t;
    }, removeNamedItemNS: function (e, t) {
      var n = this.getNamedItemNS(e, t);return z(this._ownerElement, this, n), n;
    }, getNamedItemNS: function (e, t) {
      var n = this.length;while (n--) {
        var r = this[n];if (r.localName == t && r.namespaceURI == e) return r;
      }return null;
    } }, W.prototype = { hasFeature: function (e, t) {
      var n = this._features[e.toLowerCase()];return n && (!t || t in n) ? !0 : !1;
    }, createDocument: function (e, t, n) {
      var r = new J();r.implementation = this, r.childNodes = new j(), r.doctype = n, n && r.appendChild(n);if (t) {
        var i = r.createElementNS(e, t);r.appendChild(i);
      }return r;
    }, createDocumentType: function (e, t, n) {
      var r = new ut();return r.name = e, r.nodeName = e, r.publicId = t, r.systemId = n, r;
    } }, X.prototype = { firstChild: null, lastChild: null, previousSibling: null, nextSibling: null, attributes: null, parentNode: null, childNodes: null, ownerDocument: null, nodeValue: null, namespaceURI: null, prefix: null, localName: null, insertBefore: function (e, t) {
      return Z(this, e, t);
      ...
      var e = this.firstChild;while (e) {
        var t = e.nextSibling;t && t.nodeType == f && e.nodeType == f ? (this.removeChild(t), e.appendData(t.data)) : (e.normalize(), e = t);
      }
      ...
      var t = this;while (t) {
        var n = t._nsMap;if (n) for (var r in n) if (n[r] == e) return r;t = t.nodeType == 2 ? t.ownerDocument : t.parentNode;
      }return null;
    }, lookupNamespaceURI: function (e) {
      var t = this;while (t) {
        var n = t._nsMap;if (n && e in n) return n[e];t = t.nodeType == 2 ? t.ownerDocument : t.parentNode;
      }return null;
    }, isDefaultNamespace: function (e) {
      var t = this.lookupPrefix(e);return t == null;
    } }, r(o, X), r(o, X.prototype), J.prototype = { nodeName: "#document", nodeType: v, doctype: null, documentElement: null, _inc: 1, insertBefore: function (e, t) {
      if (e.nodeType == g) {
        var n = e.firstChild;while (n) {
      ...
      var t = null;return $(this.documentElement, function (n) {
        if (n.nodeType == 1 && n.getAttribute("id") == e) return t = n, !0;
      }), t;
    }, createElement: function (e) {
      var t = new tt();t.ownerDocument = this, t.nodeName = e, t.tagName = e, t.childNodes = new j();var n = t.attributes = new q();return n._ownerElement = t, t;
    }, createDocumentFragment: function () {
      var e = new ct();return e.ownerDocument = this, e.childNodes = new j(), e;
    }, createTextNode: function (e) {
      var t = new it();return t.ownerDocument = this, t.appendData(e), t;
    }, createComment: function (e) {
      var t = new st();return t.ownerDocument = this, t.appendData(e), t;
    }, createCDATASection: function (e) {
      var t = new ot();return t.ownerDocument = this, t.appendData(e), t;
    }, createProcessingInstruction: function (e, t) {
      var n = new ht();return n.ownerDocument = this, n.tagName = n.target = e, n.nodeValue = n.data = t, n;
    }, createAttribute: function (e) {
      var t = new nt();return t.ownerDocument = this, t.name = e, t.nodeName = e, t.localName = e, t.specified = !0, t;
    }, createEntityReference: function (e) {
      var t = new lt();return t.ownerDocument = this, t.nodeName = e, t;
    }, createElementNS: function (e, t) {
      var n = new tt(),
          r = t.split(":"),
          i = n.attributes = new q();return n.childNodes = new j(), n.ownerDocument = this, n.nodeName = t, n.tagName = t, n.namespaceURI = e, r.length == 2 ? (n.prefix = r[0], n.localName = r[1]) : n.localName = t, i._ownerElement = n, n;
    }, createAttributeNS: function (e, t) {
      var n = new nt(),
          r = t.split(":");return n.ownerDocument = this, n.nodeName = t, n.name = t, n.namespaceURI = e, n.specified = !0, r.length == 2 ? (n.prefix = r[0], n.localName = r[1]) : n.localName = t, n;
    } }, i(J, X), tt.prototype = { nodeType: u, hasAttribute: function (e) {
      ...
      return new F(this, function (t) {
        var n = [];return $(t, function (r) {
          r !== t && r.nodeType == u && (e === "*" || r.tagName == e) && n.push(r);
        }), n;
      });
    }, getElementsByTagNameNS: function (e, t) {
      return new F(this, function (n) {
        var r = [];return $(n, function (i) {
          i !== n && i.nodeType === u && (e === "*" || i.namespaceURI === e) && (t === "*" || i.localName == t) && r.push(i);
        }), r;
      });
    } }, J.prototype.getElementsByTagName = tt.prototype.getElementsByTagName, J.prototype.getElementsByTagNameNS = tt.prototype.getElementsByTagNameNS, i(tt, X), nt.prototype.nodeType = a, i(nt, X), rt.prototype = { data: "", substringData: function (e, t) {
      ...
      var r = this.data.substring(0, e),
          i = this.data.substring(e + t);n = r + n + i, this.nodeValue = this.data = n, this.length = n.length;
    } }, i(rt, X), it.prototype = { nodeName: "#text", nodeType: f, splitText: function (e) {
      var t = this.data,
    ...
    Object.defineProperty && (Object.defineProperty(F.prototype, "length", { get: function () {
      ...
      } }), Object.defineProperty(X.prototype, "textContent", { get: function () {
        return yt(this);
      }, set: function (e) {
        switch (this.nodeType) {case 1:case 11:
            while (this.firstChild) this.removeChild(this.firstChild);(e || String(e)) && this.appendChild(this.ownerDocument.createTextNode(e));break;default:
  ...
  function s(e) {
    ...
    function s(t) {
      var s = e[t];if (!s) if (i) s = e.length == 2 ? function (n) {
        e(t, n);
      } : e;else {
        var o = arguments.length;while (--o) if (s = e[arguments[o]]) break;
      }r[t] = s && function (e) {
        s(e + f(n), e, n);
      } || function () {};
    }if (!e) {
      if (t instanceof u) return t;e = t;
    }var r = {},
        i = e instanceof Function;return n = n || {}, s("warning", "warn"), s("error", "warn", "warning"), s("fatalError", "warn", "warning", "error"), r;
  }function u() {
    this.cdata = !1;
  }function a(e, t) {
    ...
    e.currentElement ? e.currentElement.appendChild(t) : e.document.appendChild(t);
      ...
      i = e("./dom");return s.prototype.parseFromString = function (e, t) {
    var n = this.options,
        i = new r(),
        ...
        f = n.locator,
        l = n.xmlns || {},
        c = { lt: "<", gt: ">", amp: "&", quot: '"', apos: "'" };return f && s.setDocumentLocator(f), i.errorHandler = o(a, s, f), i.domBuilder = n.domBuilder || s, /\/x?html?$/.test(t) && (c.nbsp = "\u00a0", c.copy = "\u00a9", l[""] = "http://www.w3.org/1999/xhtml"), e ? i.parse(e, l, c) : i.errorHandler.error("invalid document source"), s.document;
  }, u.prototype = { startDocument: function () {
      ...
      var i = this.document,
          ...
          o = r.length;c(this, s), this.currentElement = s, this.locator && a(this.locator, s);for (var u = 0; u < o; u++) {
        var e = r.getURI(u),
            f = r.getValue(u),
            n = r.getQName(u),
            l = i.createAttributeNS(e, n);l.getOffset && a(l.getOffset(1), l), l.value = l.nodeValue = f, s.setAttributeNode(l);
      }
    }, endElement: function (e, t, n) {
      var r = this.currentElement,
          i = r.tagName;this.currentElement = r.parentNode;
    }, startPrefixMapping: function (e, t) {}, endPrefixMapping: function (e) {}, processingInstruction: function (e, t) {
      var n = this.document.createProcessingInstruction(e, t);this.locator && a(this.locator, n), c(this, n);
    }, ignorableWhitespace: function (e, t, n) {}, characters: function (e, t, n) {
      e = l.apply(this, arguments);if (this.currentElement && e) {
        if (this.cdata) {
          var r = this.document.createCDATASection(e);this.currentElement.appendChild(r);
        } else {
          var r = this.document.createTextNode(e);this.currentElement.appendChild(r);
      ...
      e = l.apply(this, arguments);var r = this.document.createComment(e);this.locator && a(this.locator, r), c(this, r);
    }, startCDATA: function () {
      this.cdata = !0;
    }, endCDATA: function () {
      this.cdata = !1;
    }, startDTD: function (e, t, n) {
      var r = this.document.implementation;if (r && r.createDocumentType) {
        var i = r.createDocumentType(e, t, n);this.locator && a(this.locator, i), c(this, i);
      }
    }, warning: function (e) {
  ...
  var r = e("../lib/oop"),
    ...
    this.setOptions = function (e) {
      ...
      var e = this.doc.getValue();if (!e) return;var t = new o(),
          n = [];t.options.errorHandler = { fatalError: function (e, t, r) {
