/// BareSpecifier=ace-builds/src-min-noconflict/mode-c9search
ace.define("ace/mode/c9search_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    function o(e, t) {
        ...
        u = function () {
        this.$rules = { start: [{ tokenNames: ["c9searchresults.constant.numeric", "c9searchresults.text", "c9searchresults.text", "c9searchresults.keyword"], regex: /(^\s+[0-9]+)(:)(\d*\s?)([^\r\n]+)/, onMatch: function (e, t, n) {
                    var r = this.splitRegex.exec(e),
                        i = this.tokenNames,
                        s = [{ type: i[0], value: r[1] }, { type: i[1], value: r[2] }];r[3] && (r[3] == " " ? s[1] = { type: i[1], value: r[2] + " " } : s.push({ type: i[1], value: r[3] }));var o = n[1],
                        u = r[4],
                        a,
                        f = 0;if (o && o.exec) {
                    ...
                    var r = e.split("\x01");if (r.length < 3) return "text";var s,
                        u,
                        a = 0,
                        f = [{ value: r[a++] + "'", type: "text" }, { value: u = r[a++], type: "text" }, { value: "'" + r[a++], type: "text" }];r[2] !== " in" && f.push({ value: "'" + r[a++] + "'", type: "text" }, { value: r[a++], type: "text" }), f.push({ value: " " + r[a++] + " ", type: "text" }), r[a + 1] ? (s = r[a + 1], f.push({ value: "(" + r[a + 1] + ")", type: "text" }), a += 1) : a -= 1;while (a++ < r.length) r[a] && f.push({ value: r[a], type: "text" });u && (/regex/.test(s) || (u = i.escapeRegExp(u)), /whole/.test(s) && (u = "\\b" + u + "\\b"));var l = u && o("(" + u + ")", / sensitive/.test(s) ? "g" : "ig");return l && (n[0] = t, n[1] = l), f;
                } }, { regex: "^(?=Found \\d+ matches)", token: "text", next: "numbers" }, { token: "string", regex: "^\\S:?[^:]+", next: "numbers" }], numbers: [{ regex: "\\d+", token: "constant.numeric" }, { regex: "$", token: "text", next: "start" }] }, this.normalizeRules();
    ...
    var r = e("../../lib/oop"),
        ...
        this.foldingStartMarker = /^(\S.*:|Searching for.*)$/, this.foldingStopMarker = /^(\s+|Found.*)$/, this.getFoldWidgetRange = function (e, t, n) {
            var r = e.doc.getAllLines(n),
                ...
                for (var c = n + 1, h = e.getLength(); c < h; c++) if (a.test(r[c])) break;l = c;
