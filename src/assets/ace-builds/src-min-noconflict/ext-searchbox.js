/// BareSpecifier=ace-builds/src-min-noconflict/ext-searchbox
ace.define("ace/ext/searchbox", ["require", "exports", "module", "ace/lib/dom", "ace/lib/lang", "ace/lib/event", "ace/keyboard/hash_handler", "ace/lib/keys"], function (e, t, n) {
    ...
    var r = e("../lib/dom"),
        ...
        this.setEditor = function (e) {
        ...
        }, this.$closeSearchBarKb = new u([{ bindKey: "Esc", name: "closeSearchBar", exec: function (e) {
                e.searchBox.hide();
            } }]), this.$searchBarKb = new u(), this.$searchBarKb.bindKeys({ "Ctrl-f|Command-f": function (e) {
            ...
            } }), this.$searchBarKb.addCommands([{ name: "toggleRegexpMode", bindKey: { win: "Alt-R|Alt-/", mac: "Ctrl-Alt-R|Ctrl-Alt-/" }, exec: function (e) {
            ...
            var i = this.editor.find(this.searchInput.value, { skipCurrent: e, backwards: t, wrap: !0, regExp: this.regExpOption.checked, caseSensitive: this.caseSensitiveOption.checked, wholeWord: this.wholeWordOption.checked, preventScroll: n, range: this.searchRange }),
                s = !i && this.searchInput.value;r.setCssClass(this.searchBox, "ace_nomatch", s), this.editor._emit("findSearchBox", { match: !s }), this.highlight(), this.updateCounter();
            ...
            var e = this.editor,
                ...
                var i = this.searchRange ? e.session.getTextRange(this.searchRange) : e.getValue(),
                    s = e.session.doc.positionToIndex(e.selection.anchor);this.searchRange && (s -= e.session.doc.positionToIndex(this.searchRange.start));var o = t.lastIndex = 0,
                    u;while (u = t.exec(i)) {
                    n++, o = u.index, o <= s && r++;if (n > f) break;if (!u[0]) {
                        t.lastIndex = o += 1;if (o >= i.length) break;
                    }
                }
        ...
        var n = e.searchBox || new c(e);n.show(e.session.getTextRange(), t);
    };
});
(function () {
