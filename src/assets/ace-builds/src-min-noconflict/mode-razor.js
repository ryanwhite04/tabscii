/// BareSpecifier=ace-builds/src-min-noconflict/mode-razor
ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"),
        ...
        a = "razor-block-",
        f = function () {
        u.call(this);var e = function (e, t) {
            return typeof t == "function" ? t(e) : t;
        },
            t = "in-braces";this.$rules.start.unshift({ regex: "[\\[({]", onMatch: function (e, n, r) {
                var i = /razor-[^\-]+-/.exec(n)[0];return r.unshift(e), r.unshift(i + t), this.next = i + t, "paren.lparen";
            } }, { start: "@\\*", end: "\\*@", token: "comment" });var n = { "{": "}", "[": "]", "(": ")" };this.$rules[t] = i.deepCopy(this.$rules.start), this.$rules[t].unshift({ regex: "[\\])}]", onMatch: function (t, r, i) {
                var s = i[1];return n[s] !== t ? "invalid.illegal" : (i.shift(), i.shift(), this.next = e(t, i[0]) || "start", "paren.rparen");
            } });
    };r.inherits(f, u);var l = function () {
        o.call(this);var e = { regex: "@[({]|@functions{", onMatch: function (e, t, n) {
                return n.unshift(e), n.unshift("razor-block-start"), this.next = "razor-block-start", "punctuation.block.razor";
            } },
            t = { "@{": "}", "@(": ")", "@functions{": "}" },
            n = { regex: "[})]", onMatch: function (e, n, r) {
                var i = r[1];return t[i] !== e ? "invalid.illegal" : (r.shift(), r.shift(), this.next = r.shift() || "start", "punctuation.block.razor");
            } },
            r = { regex: "@(?![{(])", onMatch: function (e, t, n) {
                return n.unshift("razor-short-start"), this.next = "razor-short-start", "punctuation.short.razor";
            } },
            i = { token: "", regex: "(?=[^A-Za-z_\\.()\\[\\]])", next: "pop" },
            s = { regex: "@(?=if)", onMatch: function (e, t, n) {
                return n.unshift(function (e) {
                    return e !== "}" ? "start" : n.shift() || "start";
                }), this.next = "razor-block-start", "punctuation.control.razor";
            } },
            u = [{ start: "@\\*", end: "\\*@", token: "comment" }, { token: ["meta.directive.razor", "text", "identifier"], regex: "^(\\s*@model)(\\s+)(.+)$" }, e, r];for (var a in this.$rules) this.$rules[a].unshift.apply(this.$rules[a], u);this.embedRules(f, "razor-block-", [n], ["start"]), this.embedRules(f, "razor-short-", [i], ["start"]), this.normalizeRules();
    ...
    var r = e("../token_iterator").TokenIterator,
        ...
        o = function () {};(function () {
        this.getCompletions = function (e, t, n, r) {
            if (e.lastIndexOf("razor-short-start") == -1 && e.lastIndexOf("razor-block-start") == -1) return [];var i = t.getTokenAt(n.row, n.column);if (!i) return [];if (e.lastIndexOf("razor-short-start") != -1) return this.getShortStartCompletions(e, t, n, r);if (e.lastIndexOf("razor-block-start") != -1) return this.getKeywordCompletions(e, t, n, r);
    ...
    var r = e("../lib/oop"),
        ...
        this.getCompletions = function (e, t, n, r) {
            var i = this.$completer.getCompletions(e, t, n, r),
                s = this.$htmlCompleter.getCompletions(e, t, n, r);return i.concat(s);
        }, this.createWorker = function (e) {
            return null;
