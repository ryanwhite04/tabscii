/// BareSpecifier=ace-builds/src-min-noconflict/worker-lua
"no use strict";
!function (e) {
  function t(e, t) {
    var n = e,
  ...
  (function (e, n, r) {
    ...
    function m(e) {
      ...
      for (var r = 0, i = e.length; r < i; r++) if (e[r][t] === n) return r;return -1;
    }function E(e) {
      ...
      var e = g.call(arguments),
        ...
        n = e[i];for (r in n) n.hasOwnProperty(r) && (t[r] = n[r]);
      }return t;
    }function x(e) {
      ...
      H();while (45 === t.charCodeAt(C) && 45 === t.charCodeAt(C + 1)) X(), H();if (C >= r) return { type: s, value: "<eof>", line: _, lineStart: D, range: [C, C] };var e = t.charCodeAt(C),
          ...
          if (61 === n) return j("~=");return j("~");case 58:
          if (58 === n) return j("::");return j(":");case 91:
          if (91 === n || 61 === n) return q();return j("[");case 42:case 47:case 94:case 37:case 44:case 123:case 125:case 93:case 40:case 41:case 59:case 35:case 45:case 43:case 38:case 124:
      ...
      var e = 0,
          ...
          s,
          o,
          u;u = C += 2, Z(t.charCodeAt(C)) || x({}, d.malformedNumber, t.slice(M, C));while (Z(t.charCodeAt(C))) C++;i = parseInt(t.slice(u, C), 16);if ("." === t.charAt(C)) {
        s = ++C;while (Z(t.charCodeAt(C))) C++;e = t.slice(s, C), e = s === C ? 0 : parseInt(e, 16) / Math.pow(16, C - s);
      }if ("pP".indexOf(t.charAt(C) || null) >= 0) {
        C++, "+-".indexOf(t.charAt(C) || null) >= 0 && (r = "+" === t.charAt(C++) ? 1 : -1), o = C, Y(t.charCodeAt(C)) || x({}, d.malformedNumber, t.slice(M, C));while (Y(t.charCodeAt(C))) C++;n = t.slice(o, C), n = Math.pow(2, n * r);
      }return (i + e) * n;
    }function z() {
      while (Y(t.charCodeAt(C))) C++;if ("." === t.charAt(C)) {
        C++;while (Y(t.charCodeAt(C))) C++;
      }if ("eE".indexOf(t.charAt(C) || null) >= 0) {
        C++, "+-".indexOf(t.charAt(C) || null) >= 0 && C++, Y(t.charCodeAt(C)) || x({}, d.malformedNumber, t.slice(M, C));while (Y(t.charCodeAt(C))) C++;
      ...
      var e = 0,
          ...
          i = !1,
          s,
          o;C++;while ("=" === t.charAt(C + e)) e++;if ("[" !== t.charAt(C + e)) return !1;C += e + 1, G(t.charCodeAt(C)) && (_++, D = C++), o = C;while (C < r) {
        s = t.charAt(C++), G(s.charCodeAt(0)) && (_++, D = C);if ("]" === s) {
          i = !0;for (var u = 0; u < e; u++) "=" !== t.charAt(C + u) && (i = !1);"]" !== t.charAt(C + e) && (i = !1);
        }if (i) break;
      ...
      var e = [];if ("end" !== k.value) {
        var t = It();null != t && e.push(t);while (J(",")) t = qt(), e.push(t);J(";");
      }return m(v.returnStatement(e));
    }function Mt() {
      var e = [],
          t,
          n,
          r;mt && (r = vt[vt.length - 1], vt.push(r)), t = qt(), K("then"), n = St(), e.push(m(v.ifClause(t, n))), mt && (r = gt());while (J("elseif")) wt(r), t = qt(), K("then"), n = St(), e.push(m(v.elseifClause(t, n))), mt && (r = gt());return J("else") && (mt && (r = new yt(L), vt.push(r)), n = St(), e.push(m(v.elseClause(n)))), K("end"), m(v.ifStatement(e));
    }function _t() {
      var e = Ht(),
          t;n.scope && ht(e);if (J("=")) {
        var r = qt();K(",");var i = qt(),
            s = J(",") ? qt() : null;return K("do"), t = St(), K("end"), m(v.forNumericStatement(e, r, i, s, t));
      }var o = [e];while (J(",")) e = Ht(), n.scope && ht(e), o.push(e);K("in");var u = [];do {
        var a = qt();u.push(a);
      } while (J(","));return K("do"), t = St(), K("end"), m(v.forGenericStatement(o, u, t));
    }function Dt() {
      var e;if (a === k.type) {
        var t = [],
            r = [];do e = Ht(), t.push(e); while (J(","));if (J("=")) do {
          var i = qt();r.push(i);
        } while (J(","));if (n.scope) for (var s = 0, o = t.length; s < o; s++) ht(t[s]);return m(v.localStatement(t, r));
      ...
      var e = k,
        ...
        var r = [t],
            i = [],
            s;while (J(",")) s = zt(), null == s && T("<expression>", k), r.push(s);K("=");do s = qt(), i.push(s); while (J(","));return wt(n), m(v.assignmentStatement(r, i));
      }return it(t) ? (wt(n), m(v.callStatement(t))) : N(e);
    }function Ht() {
      bt();var e = k.value;return a !== k.type && T("<name>", k), $(), m(v.identifier(e));
    }function Bt(e, t) {
      var r = [];K("(");if (!J(")")) for (;;) if (a === k.type) {
      ...
      var e, t, r;mt && (r = gt()), e = Ht(), n.scope && pt(e, !1);while (J(".")) wt(r), t = Ht(), n.scope && pt(t, !1), e = m(v.memberExpression(e, ".", t));return J(":") && (wt(r), t = Ht(), n.scope && pt(t, !1), e = m(v.memberExpression(e, ":", t))), e;
    }function Ft() {
      var e = [],
          t,
          n;for (;;) {
      ...
      var t = e.charCodeAt(0),
          ...
          return 3;case 38:case 124:
          return 7;} else if (2 === n) switch (t) {case 46:
      ...
      }var s, u;for (;;) if (l === k.type) switch (k.value) {case "[":
      ...
      if (l === k.type) switch (k.value) {case "(":
          $();var t = [],
              n = It();null != n && t.push(n);while (J(",")) n = qt(), t.push(n);return K(")"), m(v.callExpression(e, t));case "{":
      ...
      "undefined" != typeof e && $t(e), r = t.length, mt = n.locations || n.ranges, A = P();var i = Et();n.comments && (i.comments = O), n.scope && (i.globals = at);if (vt.length > 0) throw new Error("Location tracking failed. This is most likely a bug in luaparse");return i;
        ...
        v = e.ast = { labelStatement: function (e) {
        ...
        b = function (t, n) {
      for (var r = 0, i = t.length; r < i; r++) if (t[r] === n) return r;return -1;
    },
        C,
        k,
        L,
